...
Projeyi yerel ortamınızda test etmek için aşağıdaki adımları izleyiniz:

### 1. Gereksinimler
* **Node.js** (v16 veya üzeri)
* **npm** veya **yarn**
* **Expo Go** (Uygulamayı gerçek cihazda test etmek için App Store/Play Store'dan indirilmelidir)

### 2. Bağımlılıkların Yüklenmesi
Terminali proje ana dizininde açarak şu komutu çalıştırın:
```bash
npm install
